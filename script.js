const seminars = [
  {
    ...
    // isVisible: "none",
    id: 1,
    title: "A study of Riemannian maps in Kaehler geometry",
    speaker: {
      name: "تنفير فطيمة",
      grade: "أ.د",
    },
    ...
    date: "2025-02-04",
    abstract:
      "This study explores Riemannian maps in the context of Kähler geometry, focusing on conformal Riemannian maps and their subclasses: conformal anti-invariant, semi-invariant, and slant Riemannian maps. Riemannian maps serve as generalizations of isometric immersions and submersions, offering a framework to transfer geometric structures between manifolds. Key properties, such as harmonicity, geodesicness, and umbilicality, are examined, emphasizing the role of dilation in conformal mappings. Applications and theoretical insights are drawn to elucidate the geometry of source and target manifolds in almost Hermitian and Kähler settings.",
    Keywords: "",
  ...
  },
  {
    id: 2,
    title:
      "Insights into Morphological, Molecular, and Histopathological Studies of Parasitic and Zoonotic Species Across Aquatic and Terrestrial Hosts",
    speaker: {
      name: "عبد الحسان الشازلي  يونس",
      grade: "أ.د",
    },
    startHour: "12:00",
    endHour: "13:00",
    ...
    date: "2025-02-11",
    abstract:
      "This presentation explores a series of investigations into the morphology, molecular characterization, and pathogenic impacts of parasitic species across diverse hosts in Egypt and beyond. The research emphasizes zoonotic risks, evolutionary insights, and the implications of parasitic-host interactions. The parasites studied include helminths in Fish (Lake Nasser), bats and house rats. The findings highlighted zoonotic threats and provides a foundation for preventive measures.",
    Keywords: "",
  ...
  {
    id: 3,
    title: "The Nuclear Equation of state and the properties of Neutron stars",
    speaker: {
      name: "على المشناب",
      grade: "د",
    },
  ...
  },
  {
    ...
    title: "A Quarter Century of Research on Chitosan",
    speaker: {
      name: "خالد خليل",
      grade: "د",
    },
    ...
    date: "2025-05-06",
    abstract:
      "At the end of the 20th century, I found myself drawn to the emerging field of green chemistry. It was an exciting time, with a growing focus on sustainability and reducing the environmental impact of chemical processes. Over the past 25 years, I’ve dedicated my research to creating greener, safer, and more efficient ways to approach chemistry. Whether it’s developing non-toxic catalysts, exploring renewable feedstocks, or designing biodegradable materials, my goal has always been to align science with sustainability. A big part of this journey has been my work with chitosan, a natural biopolymer with some truly remarkable qualities: biodegradability, and antimicrobial activity, to name a few. I’ve published over 30 papers on the subject, exploring its potential applications in pharmaceuticals, agriculture, and environmental science. My research has focused on creating innovative materials like drug delivery systems, bioactive coatings, water purification agents, and nano-catalysts for organic transformations. I’ve also worked on modifying chitosan to make it even more efficient and adaptable for specific uses. At its core, my work is about finding sustainable solutions and pushing the boundaries of what this versatile material can do.",
    Keywords: "",
